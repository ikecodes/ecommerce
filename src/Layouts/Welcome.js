...
const Welcome = ({ handleShowLocator }) => {
  return (
    <div className='fixed bg-[rgb(0,0,0,0.5)] h-[100vh] w-full grid place-content-center z-[1000]'>
      <div className='bg-white rounded-lg py-20 px-28 capitalize text-center'>
        ...
        <button className='bg-[#3EC1F9] mt-4 text-white rounded-full flex items-center space-x-4 justify-items-around uppercase p-2 px-8 m-auto my-4'>
          <FaMapMarkerAlt />
          <span className='text-sm' onClick={handleShowLocator}>
            select location
          </span>
        </button>
